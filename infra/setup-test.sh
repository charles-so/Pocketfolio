#!/bin/bash
# ============================================================
# Azure Infrastructure Setup - TEST Environment
# Run: bash infra/setup-test.sh
# ============================================================
...
SQL_SERVER="charles-finance-sql-test"
SQL_DB="EnvelopeBudget"
SQL_ADMIN="sqladmin"
APP_SERVICE_PLAN="charles-finance-plan-test"
APP_SERVICE="charles-finance-api-test"
SWA="charles-finance-web-test"
APP_INSIGHTS="charles-finance-insights-test"
LOG_WORKSPACE="charles-finance-logs-test"
STORAGE_ACCOUNT="charlesfinancetest"
...
echo ""
echo "  Next steps:"
echo "  1. Deploy backend:  bash infra/deploy-backend.sh test"
echo "  2. Deploy frontend: bash infra/deploy-frontend.sh test"
echo "============================================"
